                        ...
                        <div class="card info-card sales-card shadow-sm ">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="ps-1 pt-4">
                                        <h6>12</h6>
                                        <p class="font-weight-bold">Order baru</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card info-card sales-card shadow-sm">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="ps-1 pt-4">
                                        <h6>6</h6>
                                        <p class="font-weight-bold">Alur Pengiriman</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card info-card sales-card shadow-sm">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="ps-1 pt-4">
                                        <h6>12</h6>
                                        <p class="font-weight-bold">Stock Habis</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card info-card sales-card shadow-sm">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="ps-1 pt-4">
                                <h6>2</h6>
                                <p class="font-weight-bold">Order Bermasalah</p>
                            </div>
                        </div>
                    </div>
                </div>
